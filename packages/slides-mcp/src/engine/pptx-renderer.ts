...
function addHeaderBand(s: PptxSlide, title: string, slideNum: number, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  s.addShape("rect", {
    x: 0, y: 0, w: W, h: 0.85,
...
function addFooter(s: PptxSlide, colors: typeof DEFAULT_COLORS, font: string) {
  s.addShape("rect", {
...
function renderCover(pptx: Pptx, slide: Slide, colors: typeof DEFAULT_COLORS, font: string) {
...
function renderAgenda(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
...
function renderSectionHeader(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.navy };
...
function renderKeyInsight(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.offWhite };
  addHeaderBand(s, slide.title, slide.order, total, colors, font);
...
function renderContent(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.offWhite };
  addHeaderBand(s, slide.title, slide.order, total, colors, font);
...
function renderTwoColumn(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.offWhite };
  addHeaderBand(s, slide.title, slide.order, total, colors, font);
...
function renderTable(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.offWhite };
  addHeaderBand(s, slide.title, slide.order, total, colors, font);
...
function renderProcess(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.offWhite };
  addHeaderBand(s, slide.title, slide.order, total, colors, font);
...
function renderTimeline(pptx: Pptx, slide: Slide, total: number, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.offWhite };
  addHeaderBand(s, slide.title, slide.order, total, colors, font);
  ...
  const statusColors: Record<string, string> = { "완료": colors.teal, "진행중": colors.blue, "예정": colors.textLight };
...
function renderClosing(pptx: Pptx, slide: Slide, colors: typeof DEFAULT_COLORS, font: string) {
  const s = pptx.addSlide();
  s.background = { color: colors.navy };
...
export async function renderToPptx(
  ...
  if (options?.design?.primaryColor) colors.navy = options.design.primaryColor.replace("#", "");
  if (options?.design?.accentColor) colors.blue = options.design.accentColor.replace("#", "");
