...
import type { GenerateOptions, GenerateResult, SlideFormat, SectionInput } from "../types.js";
...
export const GENERATE_SLIDES_SCHEMA = {
  ...
  description:
    "마크다운 문서 또는 섹션 구조를 슬라이드 덱으로 변환합니다. " +
...
export function executeGenerateSlides(args: GenerateOptions): GenerateResult {
  const format: SlideFormat = args.format || "pitch";
