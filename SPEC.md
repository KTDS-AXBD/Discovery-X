...
### 버전
- **프로토타입**: v6.22 + Service Layer 확장 — discoveries/$id 서브라우트 15개 (세션 261)
...
- **코드**: ~63,500줄 (397파일) — 세션 261 Service Layer 확장: discoveries/$id 서브라우트 15개 + query.ts +131줄 + entity.ts +296줄 + query-extra2.ts 신규
