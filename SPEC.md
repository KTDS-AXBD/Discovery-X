...
- ⏳ 프로덕션 배포 후 `/radar` UI에서 GeekNews web 소스 추가 필요
...
- **Radar Worker**: ✅ 프로덕션 배포 완료 (https://radar-worker.sinclair-account.workers.dev), Cron 매일 9:00 KST, 9소스 활성 (RSS 6 + Web 2 + YouTube 1)
...
- [x] GeekNews RSS 대안 확인 — web 스크래핑 전환 (User-Agent 개선, 프로덕션 UI에서 소스 추가)
