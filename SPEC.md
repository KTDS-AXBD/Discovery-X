...
| **테스트 인프라** | ✅ | Vitest + Playwright, 전체 216개 통과 (unit 76 + DB 스모크 15 + Agent 도구 통합 72 + 기존 integration 53) |
...
| **테스트 커버리지 확장** | ✅ | DB 스모크 15 + Agent discovery-tools 52 + method-tools 20 → 전체 216개 통과 |
