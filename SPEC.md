...
- 검증 항목: ontologyType 검증 + 스킵, strength 정규화(0~1↔0~100), Discovery 소속 검증, Union-find 연결 요소 계산, 중복 후보 reviewed 상태 관리, merge content 병합(400자 제한)
...
| **테스트 인프라** | ✅ | Vitest + Playwright, 전체 237개 통과 (unit 76 + DB 스모크 15 + Agent 도구 통합 93 + 기존 integration 53) |
