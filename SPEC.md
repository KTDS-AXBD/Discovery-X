...
### 현재 단계
**🚀 v4 Phase 2 - Repository 테스트 + Markdown Export (2026-02-04)**
...
- ✅ Task 간 의존성 순서 보장 (`claimTasks` 함수 개선)
  ...
  - GENERATE_OPPORTUNITIES → CLUSTER_THEMES / SCORE_OPPORTUNITIES
...
- ✅ `getPrecedingTaskTypes()` 함수 추가 (`task-types.ts`)
- ✅ Task 의존성 검증 통합 테스트 6개 추가 (`task-queue.test.ts`)
- ✅ 환경 변수 타입 정의 추가 (`OPENAI_API_KEY` 등)
- ✅ 프로덕션 배포 완료 (https://dx.minu.best)
