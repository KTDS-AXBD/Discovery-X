...
- **배포 상태**: ✅ 세션 21 프로덕션 배포 완료 (https://discovery-x.pages.dev)
- **이메일 설정**: 미설정 (나중에 Resend 연동 가능, 인앱 배지로 대체)
...
- [ ] Resend secrets 설정 + 외부 cron 서비스 연동 (이메일 알림 활성화, 선택사항)
