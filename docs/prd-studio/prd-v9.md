...
**버전:** v9 (pm-skills 통합, Conditional 해소)
**날짜:** 2026-03-12
**작성자:** AX BD팀
**상태:** 🔄 검토 중
...
### 6.3 AI 검토 품질 PoC
Phase 2-1에서 CLI vs 웹 동일 PRD 비교. verdict 100% 일치, 피드백 ±20%.
...
### 7.4 배포: Feature Flag `PRD_STUDIO_ENABLED` / 프리뷰 배포 후 UAT / 즉시 비활성화
### 7.5 보안: 전송 고지 / 작성 지침 / 서버사이드 API 키 / cascade 삭제
### 7.6 인력: 1명 — Escalation: BD팀 리더 / API: 월 $30 미만
...
| v9 | Conditional 해소: KPI 측정 구체화(§2), 에러 처리 UX(§4.4), 인증/권한(§7.3) | - |
