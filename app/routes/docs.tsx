      ...
      {tab === "github" && (
        <Card>
          <CardContent className="p-0">
            ...
            {/* Fallback link — always shown below iframe as secondary action, primary if error */}
            <div
              className={`flex items-center justify-center gap-3 ${
                iframeError ? "py-16" : "border-t border-[var(--axis-border-default)] py-3"
              }`}
            >
              <svg
              ...
              <svg
                className="h-4 w-4 text-[var(--axis-text-tertiary)]"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="currentColor"
