...
// ============================================================================
// GET /api/prd-studio/gtm/:ideaId/status
// ============================================================================
...
export async function loader({ params, request, context }: LoaderFunctionArgs) {
  ...
  const result = await service.getStrategyResult(ideaId);
  ...
  return json({
    status: result.resultGtm ? "COMPLETED" : "PENDING_GTM",
    hasStrategy: !!result.resultStrategy,
    hasGtm: !!result.resultGtm,
