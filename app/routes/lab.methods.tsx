...
export default function LabMethodsPage() {
  ...
  return (
    <div>
      ...
      <div className="mb-5">
        <h2
          className="text-sm font-semibold uppercase tracking-wider text-[var(--dx-lab-accent)]"
      ...
      <div className="mb-5 flex items-center gap-2">
        <span
          className="mr-1 text-[10px] uppercase tracking-widest text-[var(--axis-text-tertiary)]"
          style={{ fontFamily: "var(--dx-font-mono)" }}
        >
          Filter
        </span>
        <button
          className={`rounded px-2.5 py-1 text-[11px] font-medium tracking-wide transition-colors ${
            !tierFilter
              ...
              : "border border-[var(--dx-border-subtle,var(--axis-border-default))] text-[var(--axis-text-tertiary)] hover:text-[var(--axis-text-secondary)]"
          }`}
          style={{ fontFamily: "var(--dx-font-mono)" }}
      ...
      {filteredPacks.length === 0 && (
        <div className="mt-12 flex flex-col items-center justify-center text-center">
          <div
            className="rounded-full border border-[var(--dx-border-subtle,var(--axis-border-default))] p-3"
          >
            <svg className="h-6 w-6 text-[var(--axis-text-tertiary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 0-6.23.693L5 14.5m14.8.8 1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0 1 12 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
            </svg>
          </div>
          <p
            className="mt-3 text-xs uppercase tracking-wider text-[var(--axis-text-tertiary)]"
            style={{ fontFamily: "var(--dx-font-mono)" }}
          >
            No packs found
          </p>
