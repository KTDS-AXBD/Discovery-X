/**
 * Discovery Service — BC entry point (Facade + re-exports).
 */
import type { DB } from "~/db";
import { DiscoveryQueryService } from "./query";
import { DiscoveryWorkflowService } from "./workflow";
import { DiscoveryEntityService } from "./entity";

// re-export sub-services
export { DiscoveryQueryService } from "./query";
