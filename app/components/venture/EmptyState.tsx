/**
 * 범용 빈 상태 컴포넌트
 * 스프린트/탭에 콘텐츠가 없을 때 표시되는 UI + CTA
 * 모든 props는 optional — 기존 사용처(venture.overview.tsx) 변경 불필요
 */
...
export function EmptyState({
  title = "첫 번째 스프린트를 시작해보세요",
  description = "Venture Discovery Sprint는 AI Agent가 주도하여 새로운 사업 기회를 발굴하고 검증하는 프로세스입니다. 관심 있는 도메인을 설정하고 자동화된 탐색을 시작하세요.",
  ctaLabel = "첫 스프린트 시작하기",
  ctaTo = "/venture/sprints/new",
